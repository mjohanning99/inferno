...
\thispagestyle{empty}
\begin{center}
  \includegraphics[scale=0.162]{cover-ideas/cover4.png}
\end{center}
\newpage
...
\noindent© 2020 by Marvin Johanning\\``The Inferno Adventures: Inspecting the Inferno Operating System'' by Marvin Johanning is licensed under CC BY-NC-SA 4.0. To view a copy of this license, visit https://creativecommons.org\allowbreak/licenses/by-nc-sa/4.0.
...
\chapter*{Commencing the Descent}
  ...
  \begin{wrapfigure}{L}{0.55\textwidth}
    \centering
    \includegraphics[width=0.5\textwidth]{games.png}
...
Upon having unveiled the mysteries behind this fascinating operating system, I believe it is time to shortly investigate the intricacies behind the programming language it has been written in — Limbo; truly, the name, once more, appears to have been derived from Dante's works — a matter I should not be too astonished over — and bears strong resemblance to the language used in the creation of the Unix system, namely \textit{C}. 
